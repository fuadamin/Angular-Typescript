...
L.Draw.Polyline = L.Draw.Feature.extend({
	...
	_updateFinishHandler: function () {
		...
		// Inserted @Enoch
        // Remove latest vertex if user attempts to click marker more 6 and update tool tip
        if (markerCount > 6) {
			this._tooltip.updateContent({ text: L.drawLocal.draw.handlers.polyline.tooltip.max });
